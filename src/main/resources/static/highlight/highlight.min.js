...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `c` grammar compiled for Highlight.js 11.6.0 */
...
strings:i,keywords:u}}}})();hljs.registerLanguage("c",e)})();/*! `go` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("go",e)})();/*! `ruby` grammar compiled for Highlight.js 11.6.0 */
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `cpp` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("java",e)})();/*! `sql` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `javascript` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("javascript",e)})();/*! `csharp` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
